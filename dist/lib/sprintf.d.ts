/**
 * Interpolate values into a string using a `sprintf`-like syntax. Each
 * instance of "`%s`" in the string will be replaced with a given value in the
 ...
 */
export declare const sprintf: (string: string, ...args: string[]) => string;
