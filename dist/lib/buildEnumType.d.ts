 ...
 */
export declare const buildEnumType: (config: gqlc.EnumTypeComposerAsObjectDefinition) => RTE.ReaderTaskEither<Dependencies, never, gatsby.GatsbyGraphQLEnumType>;
